...
enum {
    ...
    IESETCNTLKA = 156,         // Unable to set socket keepalive (SO_KEEPALIVE) option
    IESETCNTLKAKEEPIDLE = 157, // Unable to set socket keepalive TCP period (TCP_KEEPIDLE) option
    IESETCNTLKAINTERVAL = 158, // Unable to set/get socket keepalive TCP retry interval (TCP_KEEPINTVL) option
    IESETCNTLKACOUNT = 159,    // Unable to set/get socket keepalive TCP number of retries (TCP_KEEPCNT) option
    /* Stream errors */
